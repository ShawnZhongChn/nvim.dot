...
function M.info()
  ...
  lines[#lines + 1] = "```"
  ShawnVim.info(lines, { title = "ShawnVim Roots" })
...
function M.setup()
  vim.api.nvim_create_user_command("LazyRoot", function()
    ShawnVim.root.info()
  end, { desc = "ShawnVim roots for the current buffer" })
  ...
  vim.api.nvim_create_autocmd({ "LspAttach", "BufWritePost", "DirChanged", "BufEnter" }, {
    group = vim.api.nvim_create_augroup("shawnvim_root_cache", { clear = true }),
...
function M.get(opts)
  ...
  return ShawnVim.is_win() and ret:gsub("/", "\\") or ret
end
