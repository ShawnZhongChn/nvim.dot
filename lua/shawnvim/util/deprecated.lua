---@class shawnvim.util.deprecated
local M = {}
...
M.moved = {
  ...
  ui = {
    ...
    foldexpr = { "ShawnVim.treesitter.foldexpr", stacktrace = false },
    fg = {
...
function M.decorate(name, mod)
  ...
  return setmetatable(mod, {
    __call = function(_, ...)
      ...
      ShawnVim.deprecate("ShawnVim." .. name, to)
    ...
    __index = function(_, k)
      if M.moved[name][k] then
        ...
        ShawnVim.deprecate("ShawnVim." .. name .. "." .. k, to, {
...
function M.lazygit()
  ShawnVim.deprecate("ShawnVim.lazygit", "Snacks.lazygit")
...
function M.toggle()
  ShawnVim.deprecate("ShawnVim.toggle", "Snacks.toggle")
  return {
    map = function() end,
    wrap = function()
      return {}
