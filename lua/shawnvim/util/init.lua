...
---@class shawnvim.util: LazyUtilCore
---@field config ShawnVimConfig
---@field treesitter shawnvim.util.treesitter
---@field lsp shawnvim.util.lsp
---@field root shawnvim.util.root
---@field terminal shawnvim.util.terminal
---@field format shawnvim.util.format
---@field plugin shawnvim.util.plugin
---@field extras shawnvim.util.extras
---@field inject shawnvim.util.inject
---@field news shawnvim.util.news
---@field json shawnvim.util.json
---@field lualine shawnvim.util.lualine
---@field mini shawnvim.util.mini
---@field pick shawnvim.util.pick
---@field cmp shawnvim.util.cmp
---@field deprecated shawnvim.util.deprecated
local M = {}
M.deprecated = require("shawnvim.util.deprecated")
...
--- * If the module was added by ShawnExtras
--- * If the module is in the user's lazy imports
---@param extra string
function M.has_extra(extra)
  local Config = require("shawnvim.config")
  local modname = "shawnvim.plugins.extras." .. extra
  local LazyConfig = require("lazy.core.config")
  -- check if it was imported already
  if vim.tbl_contains(LazyConfig.spec.modules, modname) then
    return true
  end
  -- check if it was added by ShawnExtras
...
for _, level in ipairs({ "info", "warn", "error" }) do
  M[level] = function(msg, opts)
    opts = opts or {}
    opts.title = opts.title or "ShawnVim"
...
-- Safe wrapper around snacks to prevent errors when ShawnVim is still installing
...
function M.set_default(option, value)
  ...
  local g = ShawnVim.config._options[option] or vim.api.nvim_get_option_value(option, { scope = "global" })
