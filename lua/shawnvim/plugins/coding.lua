return {
  ...
  -- repeat those selections to select an outer text object.
  {
    ...
    opts = function()
      ...
      return {
        ...
        custom_textobjects = {
          ...
          g = ShawnVim.mini.ai_buffer, -- buffer
    ...
    config = function(_, opts)
      ...
      ShawnVim.on_load("which-key.nvim", function()
        vim.schedule(function()
          ShawnVim.mini.ai_whichkey(opts)
        end)
      end)
    end,
  },
  ...
  -- while editing your Neovim configuration.
  {
    ...
    opts = {
      library = {
        ...
        { path = "ShawnVim", words = { "ShawnVim" } },
        { path = "snacks.nvim", words = { "Snacks" } },
        { path = "lazy.nvim", words = { "ShawnVim" } },
