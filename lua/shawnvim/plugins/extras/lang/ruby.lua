if shawnvim_docs then
  ...
  vim.g.shawnvim_ruby_lsp = "ruby_lsp"
  vim.g.shawnvim_ruby_formatter = "rubocop"
end

local lsp = vim.g.shawnvim_ruby_lsp or "ruby_lsp"
local formatter = vim.g.shawnvim_ruby_formatter or "rubocop"
