...
return {
  ...
  -- Set up nvim-jdtls to attach to java files.
  {
    ...
    opts = function()
      ...
      if ShawnVim.has("mason.nvim") then
    ...
    config = function(_, opts)
      ...
      if ShawnVim.has("mason.nvim") then
        ...
        if opts.dap and ShawnVim.has("nvim-dap") and mason_registry.is_installed("java-debug-adapter") then
      ...
      local function attach_jdtls()
        ...
        local config = extend_or_override({
          ...
          capabilities = ShawnVim.has("blink.cmp") and require("blink.cmp").get_lsp_capabilities() or ShawnVim.has(
            "cmp-nvim-lsp"
