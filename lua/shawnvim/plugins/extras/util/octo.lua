return {
  ...
  { import = "shawnvim.plugins.extras.lang.git" },
  ...
  -- Octo Picker
  {
    ...
    opts = function(_, opts)
      ...
      if ShawnVim.has_extra("editor.telescope") then
        opts.picker = "telescope"
      elseif ShawnVim.has_extra("editor.fzf") then
        opts.picker = "fzf-lua"
      elseif ShawnVim.has_extra("editor.snacks_picker") then
        opts.picker = "snacks"
      else
        ShawnVim.error("`octo.nvim` requires `telescope.nvim` or `fzf-lua` or `snacks.nvim`")
      end
