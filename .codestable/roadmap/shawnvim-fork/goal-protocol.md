...
本文件复制到 `.codestable/roadmap/shawnvim-fork/goal-protocol.md` 后，由 `/goal` 会话读取。详细执行规则拆到同目录子文档，避免单个 md 超过 300 行。

## 1. 先读文件

- `.codestable/roadmap/shawnvim-fork/goal-state.yaml`
- `.codestable/roadmap/shawnvim-fork/goal-plan.md`
- `.codestable/roadmap/shawnvim-fork/shawnvim-fork-roadmap.md`
- `.codestable/roadmap/shawnvim-fork/shawnvim-fork-items.yaml`
- `.codestable/roadmap/shawnvim-fork/goal-features/*.md`
- `.codestable/roadmap/shawnvim-fork/goal-protocol-feature-loop.md`
- `.codestable/roadmap/shawnvim-fork/goal-protocol-gates.md`
- `.codestable/roadmap/shawnvim-fork/goal-protocol-audit.md`
...
Plan: .codestable/roadmap/shawnvim-fork/goal-plan.md
Protocol: .codestable/roadmap/shawnvim-fork/goal-protocol.md
```
